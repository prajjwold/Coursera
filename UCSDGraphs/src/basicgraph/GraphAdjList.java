...
public class GraphAdjList extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		...
		List<Integer> dist2Neighbours = new ArrayList<Integer>();
		for (Integer neighbour1 : getNeighbors(v)) {
			for (Integer neighbour2 : getNeighbors(neighbour1)) {
				if (!dist2Neighbours.contains(neighbour2)) {
					dist2Neighbours.add(neighbour2);
				}
			}
		}
		return dist2Neighbours;
	}
