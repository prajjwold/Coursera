...
public class EfficientDocument extends Document {
	...
	public static void main(String[] args) {
		...
		// "This is a test. How many??? " + "Senteeeeeeeeeences are here...
		// there should be 5! Right?");
		// new EfficientDocument("");
		// new EfficientDocument(
		// "sentence, with, lots, of, commas.! " + "(And some poaren)). The
		// output is: 7.5.");
		// new EfficientDocument("many??? Senteeeeeeeeeences are");
